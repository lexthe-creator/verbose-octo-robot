...
const SMART_DEFAULTS = {
  strength: {
    ...
    5: ['upper', 'lower', 'full_body', 'upper', 'lower'],
  },
  hybrid: {
    3: ['full_body', 'run', 'full_body'],
